...
in `metOcean`_ .. |emdash| excellent!
...
::
   ...
   git clone git://github.com/metarelate/metOcean.git
...
Then, send the generated patch files to the `metOcean
...
#. Finally, make your commits into patches.  You want all the
   ...
   Send these files to the `metOcean mailing list`_.
...
Fork the `metOcean`_ repository on github |emdash| :ref:`forking`.
Then::
   ...
   git remote add origin git@github.com:your-user-name/metOcean.git
